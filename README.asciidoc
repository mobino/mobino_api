...
| +message_class+ (string) | the transaction status, either +\"in_progress\"+, +\"success\"+, or +\"failure\"+
| +retry+ (boolean)        | a bool indicating wheather or not you should ping again, false if the transaction failed or is completed
|========
...
Call the URL +http://merchants.mobino.com/api/v1/preferred_phone_numbers+ with
...
.Example
----
GET /api/v1/preferred_phone_numbers?ip=12.12.12.12&lang=de

{ 'country' : 'CH',
  'preferred_number' : ['CH', 'de', '+41 43 508 05 18'],
  'other_numbers' : [['CH', 'fr', '+41 22 123 12 12'],
                     ['DE', 'de', '+49 89 123 123 123']]
}
----
